                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <c:if ${Title} ></c:if>
                            <li><a href="/login_signup.html#login"><i class="fa fa-user"></i> Login</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.html">Cart - <span class="cart-amunt">$0</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
